...
@Component({
  ...
  imports: [  CommonModule,NgIf,FormsModule,ReactiveFormsModule,MatIconModule, MatFormFieldModule, MatInputModule, MatButtonModule,MatSelectModule],
...
export class UserdetailComponent implements OnInit {
 ...
 goBack(): void {
  ...
  submitUser(): void {
    ...
    this.http.put(updateUrl, this.userForm.value).subscribe({
      next: () => {
